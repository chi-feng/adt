...
const AppConfig = {
    // --- Analysis Settings ---
    ANALYSIS_MAX_FREQ: 18000,     // Target max frequency for analysis/display (Hz)
    ...
    MIN_DB_FLOOR: -100,      // Floor for dB normalization in spectrograms
    ...
    SPECTRUM_MAX_DB: -15,         // Max dB for spectrum chart y-axis
